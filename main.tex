...
\usepackage{fontspec} % XeLaTeX дээр системийн Unicode фонт ашиглахад хэрэгтэй
...
\addto\captionsmongolian{%
  \renewcommand{\prefacename}{Өмнөх үг}%
  \renewcommand{\refname}{Ашигласан ном}%
  \renewcommand{\abstractname}{Удиртгал}%
  ...
  \renewcommand{\indexname}{Товъёог}%
  \renewcommand{\authorname}{Нэрийн хэлхээ}%
  \renewcommand{\figurename}{Зураг}%
  \renewcommand{\tablename}{Хүснэгт}%
  \renewcommand{\partname}{Хэсэг}%
  \renewcommand{\enclname}{Ишлэл}%
  \renewcommand{\ccname}{э.с.}%
  \renewcommand{\headtoname}{}%
  \renewcommand{\pagename}{тал}%
  \renewcommand{\seename}{талд үз}%
  \renewcommand{\alsoname}{мөн талд үз}%
  \renewcommand{\proofname}{Баталгаа}%
  \renewcommand{\glossaryname}{Тайлбар}%
}
...
% Allow a little extra flexibility in line breaking so mixed Mongolian/English
% technical terms do not overflow the text block as easily.
...
\usepackage[backend=biber,style=numeric,sorting=none]{biblatex} % Ном зүйд bibtex -г ашиглах
...
\newcommand{\warn}{\ding{48}}    % circle (warning)
\newcommand{\chapterconclusiontitle}[1]{%
  \par\bigskip
  \phantomsection
...
\thesistitle{Хувийн үүлэн хадгалалтын системийн зохиомж ба хэрэгжүүлэлт} % Таны ажлын нэр, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \ttitle командыг хэрэглэнэ
...
\supervisor{Магистр (M.Sc) Э.Батцэцэг} % Удирдагчийн нэр, нүүр хуудсанд ашиглана. Дурын газарт бол \supname командыг хэрэглэнэ
\reader{.....................} % Шүүмжлэгчийн нэр, Дурын газарт бол \readname командыг хэрэглэнэ
\advisor{Доктор (Ph.D) Г.Ганбат} % Зөвлөгчийн нэр, Дурын газарт бол \advicename командыг хэрэглэнэ
\degreeind{071405000000002306} % Мэргэжлийн индекс, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \degreeid командыг хэрэглэнэ
\degree{Программ хангамжийн инженерчлэл} % Боловсролын зэрэг, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \degreename командыг хэрэглэнэ
\authorshort{Г.Алтай} % Таны товч нэр, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол \shortname командыг хэрэглэнэ 
\authorlong{Гантөмөрийн Алтай} % Таны бүтэн нэр, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол \longname командыг хэрэглэнэ 
\addresses{bbyyydriver@gmail.com} % Таны хаяг, одоогоор ашиглаагүй. Өөр газарт бол \addressname командыг хэрэглэнэ
\subject{Компьютерын ухаан} % Таны салбар, одоогоор ашиглаагүй. Дурынр газарт бол \subjectname командыг ашиглана
\keywords{Үүлэн хадгалалтын систем, веб систем, IOS native мобайл апп} % Түлхүүр үгс, одоогоор ашиглаагүй. Дурын газарт бол \keywordnames командыг хэрэглэнэ
...
\setcounter{tocdepth}{3} % Гарчигт section, subsection, subsubsection хүртэл харуулна
...
\include{FrontBackMatter/LibraryCatalog} % Номын сангийн каталогийн хуудас
